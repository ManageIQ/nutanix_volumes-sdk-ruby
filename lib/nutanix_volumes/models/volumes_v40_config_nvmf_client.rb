...
module NutanixVolumes
  ...
  class VolumesV40ConfigNvmfClient < ApiModelBase
    ...
    attr_accessor :nvmf_initiator_name
    ...
    def self.openapi_types
      {
        ...
        :'nvmf_initiator_name' => :'String',
        :'attached_targets' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVolumes::VolumesV40ConfigNvmfClient` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVolumes::VolumesV40ConfigNvmfClient`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'nvmf_initiator_name')
        self.nvmf_initiator_name = attributes[:'nvmf_initiator_name']
      end
    ...
    def list_invalid_properties
      ...
      if !@nvmf_initiator_name.nil? && @nvmf_initiator_name.to_s.length > 68
        invalid_properties.push('invalid value for "nvmf_initiator_name", the character length must be smaller than or equal to 68.')
      end

      if !@attached_targets.nil? && @attached_targets.length > 20
        invalid_properties.push('invalid value for "attached_targets", number of items must be less than or equal to 20.')
      end
    ...
    def valid?
      ...
      return false if !@nvmf_initiator_name.nil? && @nvmf_initiator_name.to_s.length > 68
      return false if !@attached_targets.nil? && @attached_targets.length > 20
    ...
    # Custom attribute writer method with validation
    # @param [Object] nvmf_initiator_name Value to be assigned
    def nvmf_initiator_name=(nvmf_initiator_name)
      if nvmf_initiator_name.nil?
        fail ArgumentError, 'nvmf_initiator_name cannot be nil'
      end

      if nvmf_initiator_name.to_s.length > 68
        fail ArgumentError, 'invalid value for "nvmf_initiator_name", the character length must be smaller than or equal to 68.'
      end

      @nvmf_initiator_name = nvmf_initiator_name
    end
    ...
    def attached_targets=(attached_targets)
      ...
      if attached_targets.length > 20
        fail ArgumentError, 'invalid value for "attached_targets", number of items must be less than or equal to 20.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ext_id == o.ext_id &&
          links == o.links &&
          nvmf_initiator_name == o.nvmf_initiator_name &&
    ...
    def hash
      [tenant_id, ext_id, links, nvmf_initiator_name, attached_targets, cluster_reference].hash
    end
