  ...
  class VolumesV40ConfigGetVolumeGroupApiResponse < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'data' => :'VolumesV40ConfigGetVolumeGroupApiResponseData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVolumes::VolumesV40ConfigGetVolumeGroupApiResponse` initialize method"
      end
