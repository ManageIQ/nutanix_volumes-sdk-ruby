  ...
  class VolumesV40ConfigGetVolumeDiskApiResponse
    ...
    def self.openapi_types
      {
        ...
        :'data' => :'VolumesV40ConfigGetVolumeDiskApiResponseData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVolumes::VolumesV40ConfigGetVolumeDiskApiResponse` initialize method"
      end
