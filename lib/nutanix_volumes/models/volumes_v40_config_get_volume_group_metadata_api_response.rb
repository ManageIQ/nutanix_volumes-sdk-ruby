  ...
  class VolumesV40ConfigGetVolumeGroupMetadataApiResponse
    ...
    def self.openapi_types
      {
        ...
        :'data' => :'VolumesV40ConfigGetVolumeGroupMetadataApiResponseData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVolumes::VolumesV40ConfigGetVolumeGroupMetadataApiResponse` initialize method"
      end
